...
class PackenServiceStatusItem extends Component {
  constructor(props) {
    super(props);
  ...
  getInitialTime = () => {
    ...
    if (this.props.data.time) {
      time = (
        ...
        >{this.props.data.time}</PackenText>
      );
    }
  ...
  getSubtitle = () => {
    ...
    if (this.props.data.subtitle) {
      subtitle = (
        ...
        >{this.props.data.subtitle}</PackenText>
      );
    }
    ...
    return (
      ...
      >
        ...
        <View style={ServiceStatusStyles.main}>
          ...
          >{this.props.data.title}</PackenText>
          {this.getSubtitle()}
        </View>
      </View>
    );
...
export default PackenServiceStatusItem;